...
VALUES ('张三'),
       ('李四')
;
INSERT INTO r2dbc.t_book (title, author_id, publish_time)
VALUES ('张三流浪记', 1, '2025-04-03 17:36:18'),
       ('张三传记', 1, '2025-04-03 17:39:39'),
       ('李四的商业帝国', 2, '2025-04-04 19:58:31'),
       ('李四的第一桶金', 2, '2025-04-04 20:00:01')
;
